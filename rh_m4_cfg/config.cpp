// config.bin - 00:45:26 02/06/15, generated in 0.06 seconds
...
class CfgAmmo {
	...
	class RH_556x45_B_Mk318 : B_556x45_Ball {
		hit = 10.0737;
		typicalSpeed = 955.243;
		airFriction = -0.00114873;
		caliber = 0.734;
		deflecting = 18;
		visibleFire = 3;
		audibleFire = 5.5;
...
class CfgWeapons {
	...
	class Zasleh2;	// External class reference
	...
	class RH_m110 : Rifle_Base_F {
		...
		magazines[] = {"RH_20Rnd_762x51_M80A1", "RH_20Rnd_762x51_Mk316LR", "RH_20Rnd_762x51_LFMJSB", "Trixie_20x762_Mag"};
		reloadAction = "GestureReloadSMG_02";
	...
	class RH_SR25EC : RH_m110 {
		...
		inertia = 0.5;
		magazines[] = {"RH_20Rnd_762x51_M80A1", "RH_20Rnd_762x51_Mk319", "RH_20Rnd_762x51_LFMJSB","Trixie_20x762_Mag"};
	...
	class RH_m4 : Rifle_Base_F {
		scope = 2;
		author = "RobertHammer";
		magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_Stanag","rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", "RH_30Rnd_556x45_Mk262", "rhs_mag_30Rnd_556x45_Mk318_Stanag", "RH_20Rnd_556x45_M855A1", "RH_20Rnd_556x45_Mk262", "RH_20Rnd_556x45_Mk318", "RH_60Rnd_556x45_M855A1", "RH_60Rnd_556x45_Mk262", "RH_60Rnd_556x45_Mk318", "30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag_Tracer_Red", "30Rnd_556x45_Stanag_Tracer_Green", "30Rnd_556x45_Stanag_Tracer_Yellow"};
		...
		class Single : Mode_SemiAuto {
			...
			class SilencedSound : BaseSoundModeType {
				begin1[] = {"RH_m4\sound\m4sd", 1, 1, 240};
				begin2[] = {"RH_m4\sound\m4sd", 1, 1, 240};
				begin3[] = {"RH_m4\sound\m4sd", 1, 1, 240};
		...
		class M203 : UGL_F {
			...
			useModelOptics = 0;
			useExternalOptic = 0;
			magazines[] = {"1Rnd_HE_Grenade_shell", "UGL_FlareWhite_F", "UGL_FlareGreen_F", "UGL_FlareRed_F", "UGL_FlareYellow_F", "UGL_FlareCIR_F", "1Rnd_Smoke_Grenade_shell", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeYellow_Grenade_shell", "1Rnd_SmokePurple_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell", "1Rnd_SmokeOrange_Grenade_shell", "rhs_mag_M441_HE","rhs_mag_M433_HEDP","rhs_mag_m714_White","rhs_mag_m713_Red","rhs_mag_m715_Green","rhs_mag_m716_yellow", "rhs_mag_m576"};
	...
	class RH_sbr9 : Rifle_Base_F {
		...
		changeFiremodeSound[] = {"A3\sounds_f\weapons\closure\firemode_changer_2", 0.562341, 1, 15};
	...
	class RH_Mk12mod1 : RH_M16A4 {
		...
		weaponInfoType = "RscWeaponZeroing";
		magazines[] = {"RH_30Rnd_556x45_Mk262", "rhs_mag_30Rnd_556x45_Mk318_Stanag", "RH_20Rnd_556x45_Mk262", "RH_20Rnd_556x45_Mk318", "RH_60Rnd_556x45_Mk262", "RH_60Rnd_556x45_Mk318"};
		inertia = 0.6;
		tmr_autorest_deployable = 1;
