...
class CfgFactionClasses {
	class USAF {
		...
		priority = 100;
		side = 1;
        icon = "\x\a3ru\addons\a3ru_main\USAFFix\Icon.paa";
     };
};
...
class CfgFunctions
{
	class Lala_C17
	{
		class Cargo_C17
		{
			file = "\x\a3ru\addons\a3ru_main\USAFFix\C17\Functions\Cargo";
			class getHeight {};
		};
	};
	class USAF_C130
	{
		class Cargo_C130
		{
			file = "\x\a3ru\addons\a3ru_main\USAFFix\C130\Functions\Cargo";
		};
	};
};
