...
class RDS_M119_base : RDS_D30_base {
	class AGM_Actions : AGM_Actions {
		class AGM_LoadStMagHE {
			...
			statement = "[_this select 0, 'M119_at_out', 'RDS_1Rnd_105mmHE_M119', 20, 'STR_HMG_Static_Loading_M119_HE'] call HMG_Static_fnc_LoadStatic";
			showDisabled = 0;
			priority = 2.5;
			icon = "";  // @todo
			enableInside = 1;
		...
		class AGM_LoadStMagWP {
			...
			statement = "[_this select 0, 'M119_wp_out', 'RDS_1Rnd_105mmWP_M119', 20, 'STR_HMG_Static_Loading_M119_WP'] call HMG_Static_fnc_LoadStatic";
			showDisabled = 0;
			priority = 2.5;
			icon = "";  // @todo
			enableInside = 1;
		...
		class AGM_LoadStMagLG {
			...
			statement = "[_this select 0, 'M119_laser_out', 'RDS_1Rnd_105mmLASER_M119', 20, 'STR_HMG_Static_Loading_M119_LG'] call HMG_Static_fnc_LoadStatic";
			showDisabled = 0;
			priority = 2.5;
			icon = "";  // @todo
			enableInside = 1;
		...
		class AGM_LoadStMagSM {
			...
			statement = "[_this select 0, 'M119_smoke_out', 'RDS_1Rnd_105mmSMOKE_M119', 20, 'STR_HMG_Static_Loading_M119_SM'] call HMG_Static_fnc_LoadStatic";
			showDisabled = 0;
			priority = 2.5;
			icon = "";  // @todo
			enableInside = 1;
		...
		class AGM_LoadStMagIL {
			...
			statement = "[_this select 0, 'M119_illum_out', 'RDS_1Rnd_105mmILLUM_M119', 20, 'STR_HMG_Static_Loading_M119_IL'] call HMG_Static_fnc_LoadStatic";
			showDisabled = 0;
			priority = 2.5;
			icon = "";  // @todo
			enableInside = 1;
