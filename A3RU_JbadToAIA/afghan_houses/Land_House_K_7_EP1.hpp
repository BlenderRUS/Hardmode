class Land_House_K_7_EP1: Jbad_House
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House7";
	ladders[] = {{ "start","end" }};
	model = "\Jbad_Structures\afghan_houses\jbad_house7.p3d";
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint"};
	replaceDamaged = "Land_jbad_house7_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses\jbad_house7_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
