class Land_House_K_6_EP1: Jbad_House
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House6";
	ladders[] = {{ "start1","end1" },{ "start2","end2" }};
	model = "\Jbad_Structures\afghan_houses\jbad_house6.p3d";
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint","HitZone_3_Hitpoint"};
	replaceDamaged = "Land_jbad_house6_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses\jbad_house6_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
	...
	actionBegin2 = "OpenDoor_3";
	actionEnd2 = "CloseDoor_3";
