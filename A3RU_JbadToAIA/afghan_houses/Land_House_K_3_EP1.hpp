class Land_House_K_3_EP1: Jbad_House
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House3";
	ladders[] = {{ "start","end" }};
	model = "\Jbad_Structures\afghan_houses\jbad_house3.p3d";
	...
	replaceDamaged = "Land_jbad_house3_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses\jbad_house3_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
	...
	class UserActions
	{
		...
		class OpenDoor_2
		{
			...
			radius = 1.5;
			onlyForPlayer = 0;
			condition = "((this animationPhase 'Door_2') < 0.5) && ((this animationPhase 'Hitzone_4_hide') < 0.99999)";
