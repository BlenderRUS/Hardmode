...
class CfgVehicles {
	...
	class Land_A_Minaret_Porto_EP1: House_F
	{
		...
		mapSize = 16.5;
		cost = 40000;
		displayName = "Minaret Porto";
		model = "\Jbad_Structures\afghan_house_a\A_Minaret_Porto\Jbad_A_Minaret_porto.p3d";
		selectionDamage = "DamT_1";
		replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint"};
		replaceDamaged = "Land_Jbad_A_Minaret_porto_dam";
		class DestructionEffects: DestructionEffects
		{
			class Ruin1
			{
				simulation = "ruin";
				type = "\Jbad_Structures\afghan_house_a\A_Minaret_Porto\Jbad_A_Minaret_Porto_ruins.p3d";
				position = "";
				intensity = 1;
				interval = 1;
				lifeTime = 1;
