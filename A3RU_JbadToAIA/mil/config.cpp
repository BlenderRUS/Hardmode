...
class CfgVehicles
{
	...
	class Land_Mil_Barracks_EP1: House_F {
		#include "Land_Jbad_Mil_Barracks.hpp"
	};
	class Land_Mil_Barracks: House_F {
		#include "Land_Jbad_Mil_Barracks.hpp"
	};
	class Land_Mil_ControlTower_EP1: House_F {
		#include "Land_Jbad_Mil_ControlTower.hpp"
	};
	class Land_Mil_ControlTower: House_F {
		#include "Land_Jbad_Mil_ControlTower.hpp"
	};
	class Land_Mil_Guardhouse_EP1: House_F {
		#include "Land_Jbad_Mil_Guardhouse.hpp"
	};
