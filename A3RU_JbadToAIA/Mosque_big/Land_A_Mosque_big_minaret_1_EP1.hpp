class Land_A_Mosque_big_minaret_1_EP1: House_F
{
	scope = 1;
	scopeCurator = 1;
	displayName = "Minaret1";
	author = "Milkman & Smokedog";
	model = "\Jbad_Structures\mosque_big\jbad_mosque_big_minaret_1.p3d";
	armor = 1000;
	...
	replaceDamaged = "Land_jbad_mosque_big_minaret_1_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\mosque_big\jbad_mosque_big_minaret_1_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
