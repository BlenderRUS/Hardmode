class Land_House_L_4_EP1: Jbad_House_old
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House 4 Old";
	model = "\Jbad_Structures\afghan_houses_old\jbad_house_4_old.p3d";
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint"};
	replaceDamaged = "Land_jbad_house_4_old_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_old\jbad_house_4_old_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
