class Land_House_L_8_EP1: Jbad_House_old
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House 8 Old";
	model = "\Jbad_Structures\afghan_houses_old\jbad_house_8_old.p3d";
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint","HitZone_3_Hitpoint"};
	replaceDamaged = "Land_jbad_house_8_old_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_old\jbad_house_8_old_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
	...
	class UserActions
	{
		...
		class OpenDoor_2: OpenDoor_1
		{
			...
			statement = "([this, 'Door_2'] execVM ""\Jbad_Structures\scripts\DoorNoHandle_open.sqf"")";
		};
		class CloseDoor_2: CloseDoor_1
		{
			condition = "((this animationPhase 'Door_2') >= 0.5)";
			statement = "([this, 'Door_2'] execVM ""\jbad_structures\scripts\DoorNoHandle_close.sqf"")";
		};
	};
