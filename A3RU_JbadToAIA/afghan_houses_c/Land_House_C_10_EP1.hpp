class Land_House_C_10_EP1: Jbad_House_c
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House C 10";
	model = "\Jbad_Structures\afghan_houses_c\jbad_house_c_10.p3d";
	armorLights = 0.01;
	ladders[] = {{ "start1","end1" }};
	...
	replaceDamaged = "Land_jbad_house_c_10_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_c\jbad_house_c_10_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
	...
	class UserActions
	{
		...
		class OpenDoor_9
		{
			...
			statement = "([this, 'Door_9','jbad_garage_door'] execVM ""\jbad_structures\scripts\GarageDoor_open.sqf"")";
		};
		class CloseDoor_9: OpenDoor_9
		{
			...
			priority = 0.2;
			condition = "((this animationPhase 'Door_9') >= 0.5)";
			statement = "([this, 'Door_9','jbad_garage_door'] execVM ""\jbad_structures\scripts\GarageDoor_close.sqf"")";
		};
		class OpenDoor_10: OpenDoor_9
		{
			position = "Door_10";
			condition = "((this animationPhase 'Door_10') < 0.5)";
			statement = "([this, 'Door_10','jbad_garage_door_broken'] execVM ""\jbad_structures\scripts\GarageDoor_open.sqf"")";
		};
		class CloseDoor_10: OpenDoor_10
		{
			displayName = "Open Garage Door";
			condition = "((this animationPhase 'Door_10') >= 0.5)";
			statement = "([this, 'Door_10','jbad_garage_door_broken'] execVM ""\jbad_structures\scripts\GarageDoor_close.sqf"")";
		};
	};
