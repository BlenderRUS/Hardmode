class Land_House_C_5_V1_EP1: Jbad_House_c
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House C 5 v1";
	model = "\Jbad_Structures\afghan_houses_c\jbad_house_c_5_V1.p3d";
	armorLights = 0.01;
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint"};
	replaceDamaged = "Land_jbad_House_c_5_v1_dam";
