class Land_House_C_3_EP1: Jbad_House_c
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House C 3";
	model = "\Jbad_Structures\afghan_houses_c\jbad_house_c_3.p3d";
	armorLights = 0.01;
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint","HitZone_3_Hitpoint"};
	replaceDamaged = "Land_jbad_house_c_3_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_c\jbad_house_c_3_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
	...
	class AnimationSources
	{
		...
		class Lock_1_source: Glass_1_source
		{
			hitpoint = "Lock_1_hitpoint";
		};
	};
	class UserActions
	{
		...
		class OpenDoor_7_Locked
		{
			displayNameDefault = "<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			displayName = "Open Doors";
			position = "Lock_1_Locked";
			priority = 0.4;
			radius = 1.2;
			onlyForPlayer = 0;
			condition = "((this animationPhase 'Lock_1_Hide') < 0.5) && ((this animationPhase 'HitZone_1_Hide') < 0.99999)";
			statement = "([this, 'Lock_1_Jiggle','Lock_1_Jiggle','Lock_1_Jiggle','Lock_1_Jiggle'] execVM ""\jbad_structures\scripts\lock.sqf"")";
		};
		class OpenDoor_7_Unlocked
		{
			displayNameDefault = "<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
			displayName = "Open Door";
			position = "Lock_1_Unlocked";
			priority = 0.4;
			radius = 1.5;
			onlyForPlayer = 0;
			condition = "((this animationPhase 'Door_8') < 0.5) && ((this animationPhase 'Lock_1_Hide') > 0.99999) && ((this animationPhase 'HitZone_1_Hide') < 0.99999)";
			statement = "([this, 'Door_8','Door_9'] execVM ""\jbad_structures\scripts\DoorsNoHandle_open.sqf"")";
		};
		class CloseDoor_7_Unlocked: OpenDoor_7_Unlocked
		{
			displayName = "Close Door";
			priority = 0.2;
			condition = "((this animationPhase 'Door_8') >= 0.5)";
			statement = "([this, 'Door_8','Door_9'] execVM ""\jbad_structures\scripts\DoorsNoHandle_close.sqf"")";
		};
	};
	...
	actionBegin5 = "OpenDoor_4";
	actionEnd5 = "CloseDoor_4";
	actionBegin6 = "OpenDoor_5";
	actionEnd6 = "CloseDoor_5";
	numberOfDoors = 5;
};