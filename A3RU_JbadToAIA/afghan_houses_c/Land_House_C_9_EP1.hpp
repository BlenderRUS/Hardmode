class Land_House_C_9_EP1: Jbad_House_c
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House C 9";
	model = "\Jbad_Structures\afghan_houses_c\jbad_house_c_9.p3d";
	armorLights = 0.01;
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint"};
	replaceDamaged = "Land_jbad_house_c_9_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_c\jbad_house_c_9_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
