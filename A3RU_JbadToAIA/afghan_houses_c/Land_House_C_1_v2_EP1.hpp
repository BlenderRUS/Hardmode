class Land_House_C_1_v2_EP1: Jbad_House_c
{
	scope = 2;
	scopeCurator = 2;
	author = "Milkman & Smokedog";
	displayName = "Afghan House C 1 v2";
	model = "\Jbad_Structures\afghan_houses_c\jbad_house_c_1_v2.p3d";
	armorLights = 0.01;
	selectionDamage = "DamT_1";
	replaceDamagedHitpoints[] = {"HitZone_1_Hitpoint","HitZone_2_Hitpoint","HitZone_3_Hitpoint"};
	replaceDamaged = "Land_jbad_house_c_1_v2_dam";
	class DestructionEffects: DestructionEffects
	{
		class Ruin1
		{
			simulation = "ruin";
			type = "\Jbad_Structures\afghan_houses_c\jbad_house_c_1_v2_ruins.p3d";
			position = "";
			intensity = 1;
			interval = 1;
			lifeTime = 1;
