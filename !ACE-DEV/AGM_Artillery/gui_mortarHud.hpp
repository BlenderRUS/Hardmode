  ...
  class AGM_Artillery_RscWeaponRangeArtilleryCustom {
    ...
    class controls
    {
      ...
      class Vector_Center : RscPicture {
        ...
        w = 0.4 / 16 * safezoneW;
        h = 0.4 / 9 * safezoneH;
        text = "\z\ace\addons\vector\rsc\Vector_Center.paa";
      };
    ...
    class objects {
      class Azimuth_Star {
        idc = 800851;
        type = 82;
        model = "\x\a3ru\addons\AGM_Artillery\data\compass_star.p3d";
        scale = COMPASS_SCALE;
        direction[] = {0, 0, 1};
        up[] = {0, 1, 0};
      ...
      class Azimuth_Base: Azimuth_Star {
        idc = 800852;
        model = "\x\a3ru\addons\AGM_Artillery\data\compass_base.p3d";
        z = 1;
      };
