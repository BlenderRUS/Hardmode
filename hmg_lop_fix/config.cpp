...
class SoldierGB;
	...
	class LOP_ChDKZ_Infantry_Bardak : I_officer_F {
		...
		weapons[] = {"rhs_weap_ak74m_gp25_npz", "Throw", "Put"};
		respawnWeapons[] = {"rhs_weap_ak74m_gp25_npz", "Throw", "Put"};
	...
	class LOP_PMC_Infantry_TL : I_Soldier_TL_F {
		...
		Items[] = {"FirstAidKit"};
		RespawnItems[] = {"FirstAidKit"};
		weapons[] = {"LOP_Weap_M4A1_BlockII_Holo", "Throw", "Put"};
		respawnWeapons[] = {"LOP_Weap_M4A1_BlockII_Holo", "Throw", "Put"};
