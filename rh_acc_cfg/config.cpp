// config.bin - 00:52:56 02/06/15, generated in 0.04 seconds
...
class CfgPatches {
	class RH_acc {
		units[] = {"RH_accbox"};
		weapons[] = {"RH_qdss_nt4", "RH_saker", "RH_Saker762", "RH_fa556", "RH_fa762", "RH_m110sd", "RH_m110sd_t", "RH_spr_mbs", "RH_tundra", "RH_peq15", "RH_peq15_top", "RH_peq15b", "RH_peq15b_top", "RH_peq2", "RH_peq2_top", RH_SFM952V, "RH_SFM952V_tan", "RH_eotech553", "RH_eotech553_tan", "RH_eotech553mag", "RH_eotech553mag_tan", "RH_eotexps3", "RH_eotexps3_tan", "RH_eothhs1", "RH_eothhs1_tan", "RH_compm4s", "RH_compM2", "RH_compM2l", "RH_t1", "RH_reflex", "RH_barska_rds", "RH_cmore", "RH_LTdocter", "RH_LTdocterl", "RH_zpoint", "RH_shortdot", "RH_accupoint", "RH_m3lr", "RH_leu_mk4", "RH_ta648", "RH_c79", "RH_c79_2d", "RH_m145", "RH_ta01nsn", "RH_ta01nsn_2D", "RH_ta01nsn_tan", "RH_ta01nsn_tan_2D", "RH_ta31rco", "RH_ta31rco_2D", "RH_ta31rco_tan", "RH_ta31rco_tan_2D", "RH_ta31rmr", "RH_ta31rmr_2D", "RH_ta31rmr_tan", "RH_ta31rmr_tan_2D", "RH_anpvs4", "RH_anpvs10", "RH_pas13cl", "RH_pas13cm", "RH_pas13cmg", "RH_pas13ch"};
		requiredVersion = 0.1;
	...
	class RH_leu_mk4 : ItemCore {
		...
		class ItemInfo : InventoryOpticsItem_Base_F {
			...
			class OpticsModes {
				class mk4 {
					opticsID = 1;
					modelOptics[] = {"\RH_acc\RH_leu_mildot6_5.p3d", "\RH_acc\RH_leu_mildot10.p3d", "\RH_acc\RH_leu_mildot19_5.p3d"};
					distanceZoomMin = 100;
					distanceZoomMax = 1200;
					opticsZoomMin = 0.038308;
					opticsZoomMax = 0.038308;
					opticsZoomInit = 0.038308;
					discretefov[] = {0.038308, 0.0249, 0.01277};
					discreteInitIndex = 0;
					opticsPPEffects[] = {"OpticsCHAbera1", "OpticsBlur1"};
					useModelOptics = 1;
					memoryPointCamera = "eye";
				...
				class mk4illum : mk4 {
					opticsID = 2;
					modelOptics[] = {"\RH_acc\RH_leu_mildot6_5illum.p3d", "\RH_acc\RH_leu_mildot10illum.p3d", "\RH_acc\RH_leu_mildot19_5illum.p3d"};
				};
			};
		};
		inertia = 0.2;
