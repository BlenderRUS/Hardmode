	...
	class hmg_infantry_msv_1995_base : SoldierEB
	{
		...
		linkedItems[] = {"rhs_6b13","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"rhs_6b13","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch"};
	...
	class hmg_msv_1995_officer_armored : hmg_msv_1995_rifleman
	{
        ...
        linkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemMap","ItemCompass","ItemWatch"};
	...
	class hmg_msv_1995_ko_r : hmg_msv_1995_officer_armored
	{
		...
		linkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemCompass","ItemWatch","ItemRadio","AGM_NVG_Gen2","ItemMap"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemCompass","ItemWatch","ItemRadio","AGM_NVG_Gen2","ItemMap"};
	};	
	class hmg_msv_1995_ko_gv : hmg_msv_1995_officer_armored
	{
		...
		linkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemCompass","ItemWatch","AGM_NVG_Gen2","ItemMap"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","rhs_6b13_crewofficer","ItemCompass","ItemWatch","AGM_NVG_Gen2","ItemMap"};
	};	
	...
	class hmg_msv_1995_driver : hmg_msv_1995_rifleman
	{
        ...
        linkedItems[] = {"rhs_tsh4","rhs_6b13","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"rhs_tsh4","rhs_6b13","ItemCompass","ItemWatch"};
		magazines[] = 		{
			"rhs_30Rnd_545x39_7N10_AK",
			"rhs_30Rnd_545x39_7N10_AK",
			"rhs_30Rnd_545x39_7N10_AK",
	...
	class hmg_msv_1995_driver_st : hmg_msv_1995_rifleman
	{
        ...
        linkedItems[] = {"rhs_tsh4","rhs_6b13","ItemCompass","ItemWatch","ItemMap"};
		respawnLinkedItems[] = {"rhs_tsh4","rhs_6b13","ItemCompass","ItemWatch","ItemMap"};
		magazines[] = 		{
			"rhs_30Rnd_545x39_7N10_AK",
			"rhs_30Rnd_545x39_7N10_AK",
			"rhs_30Rnd_545x39_7N10_AK",
	...
	class hmg_msv_1995_razved4ik: hmg_msv_1995_rifleman
	{
		...
		linkedItems[] = {"rhs_6b13","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch","AGM_NVG_Gen2"};
		respawnLinkedItems[] = {"rhs_6b13","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch","AGM_NVG_Gen2"};
		weapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
		respawnWeapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
	};	
	...
	class hmg_msv_1995_medic : hmg_msv_1995_rifleman
	{
        ...
        linkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemCompass","ItemWatch"};
		weapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
		respawnWeapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
	};
	...
	class hmg_msv_1995_medic_st : hmg_msv_1995_sergeant
	{
		...
		Items[] = {"FirstAidKit","cw_item_notepad","AGM_CableTie","AGM_MapTools"};
		RespawnItems[] = {"FirstAidKit","cw_item_notepad","AGM_CableTie","AGM_MapTools"};
		linkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemCompass","ItemWatch","ItemMap"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemCompass","ItemWatch","ItemMap"};
		weapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
		respawnWeapons[] = {"hlc_rifle_aks74u","Throw","Put"}; //hlc_rifle_aks74
		backpack="hmg_medic_sidor";
	};
	...
	class hmg_msv_1995_med_leader : hmg_msv_1995_officer_armored
	{
		...
		linkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"LOP_H_SSh68Helmet_OLV","V_CDF_A3_6b23_medic","ItemMap","ItemCompass","ItemWatch"};
		backpack = "tf_mr3000_rhs";
	};
	// разведвзвод мсб
//Командир взвода
...
//Разведчик
	...
	class hmg_msv_1995_razved4ik_strelok : hmg_msv_1995_efreitor
	{
		...
		Author_Macro
		displayName= "Разведчик (ВСР-93)";
		linkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch"};
	};
	...
	class hmg_msv_1995_razved4ik_ko : hmg_msv_1995_ko_r
	{
		...
		weapons[] = {"hlc_rifle_aks74_GL","Throw","Put","Binocular"};
		respawnWeapons[] = {"hlc_rifle_aks74_GL","Throw","Put","Binocular"};
		linkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch","ItemMap"};
		respawnLinkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass","ItemWatch","ItemMap"};
		backpack = "hmg_gp_sidor";
		magazines[] = 		{
			"rhs_30Rnd_545x39_7N10_AK",
			"rhs_30Rnd_545x39_7N10_AK",
	...
	class hmg_msv_1995_razved4ik_at : hmg_msv_1995_at
	{
		...
		Items[] = {"FirstAidKit", "rhs_acc_1pn93_2"};
		respawnItems[] = {"FirstAidKit", "rhs_acc_1pn93_2"};
        linkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass"};
		respawnLinkedItems[] = {"LOP_V_Chestrig_vsr","LOP_H_SSh68Helmet_OLV","ItemCompass"};
		weapons[] = {"hlc_rifle_aks74u","Throw","Put","rhs_weap_rpg7_pgo"};
		respawnWeapons[] = {"hlc_rifle_aks74u","Throw","Put","rhs_weap_rpg7_pgo"};
		backpack="rhs_rpgold";
	};
