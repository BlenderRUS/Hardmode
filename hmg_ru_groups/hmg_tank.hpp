...
//Разведчик
	...
	class hmg_tank_razved4ik_strelok : hmg_tank_efreitor
	{
		_generalMacro = "hmg_tank_razved4ik_strelok";
		Author_Macro
		displayName= "Разведчик (ВСР-98)";
	};
	
	class hmg_tank_razved4ik_operator_rls : hmg_tank_efreitor
	{
		_generalMacro = "hmg_tank_razved4ik_operator_rls";
		Author_Macro
		displayName= "Оператор РЛС (ВСР-98)";
	};
	
	class hmg_tank_razved4ik_stoperator_rls : hmg_tank_efreitor
	{
		_generalMacro = "hmg_tank_razved4ik_stoperator_rls";
		Author_Macro
		displayName= "Ст. оператор РЛС (ВСР-98)";
	};
	
	class hmg_tank_razved4ik_saper : hmg_tank_rifleman
	{
		_generalMacro = "hmg_tank_razved4ik_saper";
		scope = 2;
		Author_Macro
	...
	class hmg_tank_razved4ik_radist : hmg_tank_rifleman_radist
	{
		_generalMacro = "hmg_tank_razved4ik_radist";
		Author_Macro
	...
	class hmg_tank_razved4ik_machinegunner : hmg_tank_machinegunner
	{
		_generalMacro = "hmg_tank_razved4ik_machinegunner";
		Author_Macro
		displayName= "Разведчик-пулеметчик (ВСР-98)";
	};
	
	class hmg_tank_razved4ik_marksman : hmg_tank_marksman
	{
		_generalMacro = "hmg_tank_razved4ik_marksman";
		Author_Macro
	...
	class hmg_tank_razved4ik_efreitor : hmg_tank_efreitor
	{
		_generalMacro = "hmg_tank_razved4ik_efreitor";
		Author_Macro
	...
	class hmg_tank_razved4ik_ko : hmg_tank_ko_r
	{
		_generalMacro = "hmg_tank_razved4ik_ko";
		Author_Macro
	...
	class hmg_tank_razved4ik_at : hmg_tank_at
	{
		_generalMacro = "hmg_tank_razved4ik_at";
		Author_Macro
	...
	class hmg_tank_razved4ik_sbr : hmg_tank_rifleman_sbr
	{
		_generalMacro = "hmg_tank_razved4ik_sbr";
		Author_Macro
	...
	class hmg_tank_razved4ik_stradist : hmg_tank_razved4ik_radist
	{
		_generalMacro = "hmg_tank_razved4ik_stradist";
		Author_Macro
	...
	class hmg_tank_razved4ik_zkvko : hmg_tank_razved4ik_ko
	{
		_generalMacro = "hmg_tank_razved4ik_zkvko";
		Author_Macro
	...
	class hmg_tank_razved4ik_officer : hmg_tank_officer
	{
		_generalMacro = "hmg_tank_razved4ik_officer";
		Author_Macro
