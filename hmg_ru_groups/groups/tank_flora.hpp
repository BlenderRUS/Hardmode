...
class group_ru_tank_bmp_attach
			{
				...
				class group_ru_tank_omsb_scout_sq_hq_bmp
				{
					...
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_officer";
						rank = "LIEUTENANT";
						position[] = {0,3,0};
					};
				};
				class group_ru_tank_omsb_1scout_sq_bmp
				{
					...
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_zkvko";
						rank = "SERGEANT";
						position[] = {0,3,0};
					};
					class Unit1
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_stoperator_rls";
						rank = "CORPORAL";
						position[] = {2,0,0};
					};
					class Unit2
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_sbr";
						rank = "PRIVATE";
						position[] = {3,0,0};
					};
					class Unit3
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_radist";
						rank = "PRIVATE";
						position[] = {4,0,0};
					};
					class Unit4
				...
				class group_ru_tank_omsb_2scout_sq_bmp
				{
					...
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_efreitor";
						rank = "CORPORAL";
						position[] = {2,0,0};
					};
					class Unit2
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_machinegunner";
						rank = "PRIVATE";
						position[] = {3,0,0};
					};
					class Unit3
					{
						side = 0;
						vehicle = "hmg_tank_razved4ik_strelok";
						rank = "PRIVATE";
						position[] = {4,0,0};
					};
					class Unit4
				...
				class group_ru_tank_omsb_3scout_sq_bmp
				{
