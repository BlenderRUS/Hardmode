class group_ru_msv_s_bmp_attach
			{
				...
				class group_ru_msv_s_omsb_scout_sq_hq_bmp
				{
				...
				class group_ru_msv_s_omsb_1scout_sq_bmp
				{
					...
					{
						side = 0;
						vehicle = "hmg_msv_s_razved4ik_stoperator_rls";
						rank = "CORPORAL";
						position[] = {2,0,0};
					};
					class Unit2
				...
				class group_ru_msv_s_omsb_3scout_sq_bmp
				{
