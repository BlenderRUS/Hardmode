	...
	class hmg_infantry_msv_s_base : SoldierEB
	{
		...
		linkedItems[] = {"rhs_6b23_digi_rifleman","rhs_6b28","ItemCompass","tf_pnr1000a", "tf_microdagr","G_Combat"};
		respawnLinkedItems[] = {"rhs_6b23_digi_rifleman","rhs_6b28","ItemCompass","tf_pnr1000a", "tf_microdagr","G_Combat"};
	...
	class hmg_msv_s_sergeant : hmg_msv_s_rifleman
	{
		...
		Items[] = {"FirstAidKit","rhs_acc_1pn93_1" ,"AGM_MapTools","AGM_CableTie"};
		RespawnItems[] = {"FirstAidKit","rhs_acc_1pn93_1" ,"AGM_MapTools","AGM_CableTie"};
	...
	class hmg_msv_s_komvzvoda_sob : hmg_msv_s_officer_armored
	{
		...
		Items[] = {"FirstAidKit","a3ru_rangetable_2b14" ,"AGM_MapTools","ItemSMGR"};
		RespawnItems[] = {"FirstAidKit","a3ru_rangetable_2b14" ,"AGM_MapTools","ItemSMGR"};
	};
	...
	class hmg_msv_s_komandir_gsabatr : hmg_msv_s_officer
	{
		...
		Items[] = {"FirstAidKit" ,"AGM_MapTools","ItemSMGR"};
		RespawnItems[] = {"FirstAidKit" ,"AGM_MapTools","ItemSMGR"};
	};
...
//Старший оператор РЛС
	...
	class hmg_msv_s_razved4ik_strelok : hmg_msv_s_efreitor
	{
		_generalMacro = "hmg_msv_s_razved4ik_strelok";
		Author_Macro
		displayName= "Разведчик (ЕМР)";
	};
	
	class hmg_msv_s_razved4ik_operator_rls : hmg_msv_s_efreitor
	{
		_generalMacro = "hmg_msv_s_razved4ik_operator_rls";
		Author_Macro
		displayName= "Оператор РЛС (ЕМР)";
	};
	
	class hmg_msv_s_razved4ik_stoperator_rls : hmg_msv_s_efreitor
	{
		_generalMacro = "hmg_msv_s_razved4ik_stoperator_rls";
		Author_Macro
		displayName= "Ст. оператор РЛС (ЕМР)";
	};
	
	class hmg_msv_s_razved4ik_saper : hmg_msv_s_rifleman
	{
		_generalMacro = "hmg_msv_s_razved4ik_saper";
		scope = 2;
		Author_Macro
	...
	class hmg_msv_s_razved4ik_radist : hmg_msv_s_rifleman_radist
	{
		_generalMacro = "hmg_msv_s_razved4ik_radist";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_machinegunner : hmg_msv_s_machinegunner
	{
		_generalMacro = "hmg_msv_s_razved4ik_machinegunner";
		Author_Macro
		displayName= "Разведчик-пулеметчик (ЕМР)";
	};
	
	class hmg_msv_s_razved4ik_marksman : hmg_msv_s_rifleman
	{
		_generalMacro = "hmg_msv_s_razved4ik_marksman";
		Author_Macro
		...
		backpack = "hmg_msv_sniper";
	};
	
	class hmg_msv_s_razved4ik_efreitor : hmg_msv_s_efreitor
	{
		_generalMacro = "hmg_msv_s_razved4ik_efreitor";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_ko : hmg_msv_s_ko_r
	{
		_generalMacro = "hmg_msv_s_razved4ik_ko";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_at : hmg_msv_s_at
	{
		_generalMacro = "hmg_msv_s_razved4ik_at";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_sbr : hmg_msv_s_rifleman_sbr
	{
		_generalMacro = "hmg_msv_s_razved4ik_sbr";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_stradist : hmg_msv_s_razved4ik_radist
	{
		_generalMacro = "hmg_msv_s_razved4ik_stradist";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_zkvko : hmg_msv_s_razved4ik_ko
	{
		_generalMacro = "hmg_msv_s_razved4ik_zkvko";
		Author_Macro
	...
	class hmg_msv_s_razved4ik_officer : hmg_msv_s_officer
	{
		_generalMacro = "hmg_msv_s_razved4ik_officer";
		Author_Macro
		displayName= "Командир развед. взвода (ЕМР)";
		backpack = "tf_mr3000_rhs";
	};	
	
	// стрелковый (снайперский) взвод
	// снайпер-наблюдатель
	...
	class hmg_msv_s_marksman : hmg_msv_s_rifleman
	{
		...
		Author_Macro
		displayName= "Снайпер-наблюдатель (ЕМР)";
	...
	class hmg_msv_s_stmarksman : hmg_msv_s_efreitor
	{
		_generalMacro = "hmg_msv_s_stmarksman";
		Author_Macro
	...
	class hmg_msv_s_komarksman : hmg_msv_s_sergeant
	{
		_generalMacro = "hmg_msv_s_komarksman";
		Author_Macro
		displayName= "Командир отделения - снайпер (ЕМР)";
		...
		weapons[] = {"rhs_weap_svds","Throw","Put"};
		respawnWeapons[] = {"rhs_weap_svds","Throw","Put"};
		Items[] = {"FirstAidKit","rhs_acc_1pn93_1","rhs_acc_pso1m2" ,"AGM_MapTools","AGM_CableTie"};
		RespawnItems[] = {"FirstAidKit","rhs_acc_1pn93_1","rhs_acc_pso1m2" ,"AGM_MapTools","AGM_CableTie"};
		magazines[] = {"rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1"};
		respawnMagazines[] = {"rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1"};
		backpack = "hmg_msv_sniper";
	};
	
	class hmg_msv_s_zkvmarksman : hmg_msv_s_officer_armored
	{
		_generalMacro = "hmg_msv_s_zkvmarksman";
		Author_Macro
		displayName= "ЗамКом взвода - снайпер (ЕМР)";
		...
		weapons[] = {"rhs_weap_svds","Throw","Put","rhs_weap_pya","Binocular"};
		respawnWeapons[] = {"rhs_weap_svds","Throw","Put","rhs_weap_pya","Binocular"};
		Items[] = {"FirstAidKit","rhs_acc_1pn93_1","rhs_acc_pso1m2" ,"AGM_MapTools","AGM_CableTie"};
		RespawnItems[] = {"FirstAidKit","rhs_acc_1pn93_1","rhs_acc_pso1m2" ,"AGM_MapTools","AGM_CableTie"};
		magazines[] = {"rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1"};
		respawnMagazines[] = {"rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1", "rhs_10Rnd_762x54mmR_7N1"};
