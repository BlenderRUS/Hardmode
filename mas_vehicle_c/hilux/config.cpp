// config.bin - 17:01:21 01/05/15, generated in 0.03 seconds
...
class CfgPatches {
	class mas_cars_Hilux {
		units[] = {"B_mas_cars_Hilux_MG", "B_mas_cars_Hilux_AGS30", "B_mas_cars_Hilux_SPG9", "B_mas_cars_Hilux_RKTS", "B_mas_cars_Hilux_Unarmed", "B_mas_cars_Hilux_Med", "B_mas_cars_Hilux_M2"};
		weapons[] = {};
...
class CfgMovesMaleSdr : CfgMovesBasic {
	class States {
		...
		class mas_Hilux_Driver : Crew {
			file = "\mas_cars\hilux\Data\Anim\Hilux_Driver";
			interpolateTo[] = {"mas_KIA_Hilux_Driver", 1};
			speed = 1e+010;
		};
		
		class mas_KIA_Hilux_Driver : DefaultDie {
			actions = "DeadActions";
			file = "\mas_cars\hilux\Data\Anim\KIA_Hilux_Driver";
			speed = 1e+010;
			terminal = 1;
			soundEnabled = 0;
			looped = 0;
		...
		class mas_Hilux_cargo01 : Crew {
			file = "\mas_cars\hilux\Data\Anim\Hilux_Cargo01";
			interpolateTo[] = {"mas_KIA_Hilux_cargo01", 1};
			speed = 1e+010;
		};
		
		class mas_KIA_Hilux_cargo01 : DefaultDie {
			actions = "DeadActions";
			file = "\mas_cars\hilux\Data\Anim\KIA_Hilux_Cargo01";
			speed = 1e+010;
			terminal = 1;
			soundEnabled = 0;
			looped = 0;
...
class CfgVehicles {
	...
	class B_mas_cars_Hilux_Base : Car_F {
		...
		_generalMacro = "B_mas_cars_Hilux_Base";
		scope = 0;
		model = "\mas_cars\hilux\hilux_DSHK";
		displayName = "Hilux";
		...
		crew = "B_G_Soldier_F";
		typicalCargo[] = {"B_G_Soldier_F", "B_G_Soldier_F", "B_G_Soldier_F", "B_G_Soldier_F", "B_G_Soldier_F"};
		unitInfoType = "UnitInfoShip";
		driverAction = "mas_Hilux_Driver";
		cargoAction[] = {"mas_Hilux_cargo01"};
		...
		class Damage {
			tex[] = {};
			mat[] = {"mas_cars\hilux\data\coyota_trup3.rvmat", "mas_cars\hilux\Data\coyota_trup3_damage.rvmat", "mas_cars\hilux\Data\coyota_trup3_destruct.rvmat", "mas_cars\hilux\Data\drziaky.rvmat", "mas_cars\hilux\Data\drziaky_damage.rvmat", "mas_cars\hilux\Data\drziaky_destruct.rvmat", "mas_cars\hilux\Data\coyota_armed.rvmat", "mas_cars\hilux\Data\coyota_armed_damage.rvmat", "mas_cars\hilux\Data\coyota_armed_destruct.rvmat", "mas_cars\hilux\Data\coyota_interier.rvmat", "mas_cars\hilux\Data\coyota_interier_damage.rvmat", "mas_cars\hilux\Data\coyota_interier_destruct.rvmat", "mas_cars\hilux\Data\coyota_kola.rvmat", "mas_cars\hilux\Data\coyota_kola_damage.rvmat", "mas_cars\hilux\Data\coyota_kola_destruct.rvmat", "mas_cars\hilux\data\auta_skla_in.rvmat", "mas_cars\hilux\Data\auta_skla_in_damage.rvmat", "mas_cars\hilux\Data\auta_skla_in_damage.rvmat", "mas_cars\hilux\Data\auta_skla.rvmat", "mas_cars\hilux\Data\auta_skla_damage.rvmat", "mas_cars\hilux\Data\auta_skla_damage.rvmat", "mas_cars\hilux\data\default.rvmat", "mas_cars\hilux\data\default.rvmat", "mas_cars\hilux\data\default_destruct.rvmat"};
		};
	...
	class B_mas_cars_Hilux_MG : B_mas_cars_Hilux_Base {
		_generalMacro = "B_mas_cars_Hilux_MG";
		scope = 2;
		crew = "B_G_Soldier_F";
	...
	class B_mas_cars_Hilux_M2 : B_mas_cars_Hilux_MG {
		_generalMacro = "B_mas_cars_Hilux_M2";
		model = "\mas_cars\hilux\hilux_M2";
		crew = "B_G_Soldier_exp_F";
		picture = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\Offroad_01_armed_CA.paa";
		Icon = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\map_offroad_armed_CA.paa";
		displayName = "Hilux-M2.50cal";
		transportSoldier = 1;
		cargoProxyIndexes[] = {1};
	...
	class B_mas_cars_Hilux_AGS30 : B_mas_cars_Hilux_Base {
		_generalMacro = "B_mas_cars_Hilux_AGS30";
		scope = 2;
		crew = "B_G_Soldier_GL_F";
		typicalCargo[] = {"B_G_Soldier_F"};
		model = "\mas_cars\hilux\hilux_granade";
		picture = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\Offroad_01_armed_CA.paa";
		Icon = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\map_offroad_armed_CA.paa";
		mapSize = 4;
		displayName = "Hilux-AGS30";
		gunnerHasFlares = 1;
		transportSoldier = 1;
		cargoProxyIndexes[] = {1};
		...
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				...
				gunnerInAction = "mas_Hilux_Gunner";
				ejectDeadGunner = 1;
				gunnerOpticsModel = "\mas_cars\UAZ\optika_AGS30";
		...
		hiddenSelectionsTextures[] = {"\mas_cars\hilux\data\coyota_trup1_co.paa"};
	};
	
	class B_mas_cars_Hilux_Unarmed : B_mas_cars_Hilux_Base {
		_generalMacro = "B_mas_cars_Hilux_Unarmed";
		crew = "B_G_engineer_F";
		typicalCargo[] = {"B_G_Soldier_F"};
		transportSoldier = 1;
		cargoProxyIndexes[] = {1};
		...
		class Turrets : Turrets {
			class CargoTurret_01 : CargoTurret {
				...
				memoryPointsGetInGunnerDir = "pos cargo dir RR";
				gunnerName = "Gunner RR";
				proxyIndex = 2;
				maxElev = 45;
				minElev = -15;
				maxTurn = 105;
			...
			class CargoTurret_02 : CargoTurret_01 {
				...
				gunnerName = "Gunner RL";
				memoryPointsGetInGunner = "pos cargo LR";
				memoryPointsGetInGunnerDir = "pos cargo dir LR";
				proxyIndex = 3;
				maxTurn = 50;
				minTurn = -105;
			...
			class CargoTurret_03 : CargoTurret_01 {
				...
				gunnerName = "Gunner FR";
				memoryPointsGetInGunner = "pos cargo RF";
				memoryPointsGetInGunnerDir = "pos cargo dir RF";
				proxyIndex = 4;
				maxTurn = 105;
				minTurn = -20;
			...
			class CargoTurret_04 : CargoTurret_03 {
				...
				gunnerName = "Gunner FL";
				memoryPointsGetInGunner = "pos cargo LF";
				memoryPointsGetInGunnerDir = "pos cargo dir LF";
				proxyIndex = 5;
				maxTurn = 20;
				minTurn = -105;
		...
		scope = 2;
		model = "\mas_cars\hilux\hilux";
		picture = "\A3\soft_f\Offroad_01\Data\UI\Offroad_01_base_CA.paa";
		Icon = "\A3\soft_f\Offroad_01\Data\UI\map_offroad_01_CA.paa";
		mapSize = 4;
		displayName = "Hilux Unarmed";
		hiddenSelectionsTextures[] = {"\mas_cars\hilux\data\coyota_trup3_co.paa"};
	};
	
	class B_mas_cars_Hilux_Med : B_mas_cars_Hilux_Unarmed {
		_generalMacro = "B_mas_cars_Hilux_Med";
		displayName = "Hilux-MEV";
		crew = "B_G_medic_F";
		typicalCargo[] = {"B_G_medic_F", "B_G_medic_F"};
		supplyRadius = 10;
		attendant = 1;
		threat[] = {0, 0, 0};
		transportSoldier = 3;
		cargoProxyIndexes[] = {1, 4, 5};
		cargoAction[] = {"mas_Hilux_cargo01", "passenger_flatground_crosslegs", "passenger_flatground_crosslegs"};
		class CargoTurret;	// External class reference
		...
		hiddenSelectionsTextures[] = {"\mas_cars\hilux\data\coyota_trupmed.paa"};
	};
	
	class B_mas_cars_Hilux_SPG9 : B_mas_cars_Hilux_Base {
		_generalMacro = "B_mas_cars_Hilux_SPG9";
		scope = 2;
		crew = "B_G_Soldier_M_F";
		typicalCargo[] = {"B_G_Soldier_F"};
		model = "\mas_cars\hilux\hilux_SPG9";
		picture = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\Offroad_01_armed_CA.paa";
		Icon = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\map_offroad_armed_CA.paa";
		mapSize = 4;
	...
	class B_mas_cars_Hilux_RKTS : B_mas_cars_Hilux_SPG9 {
		_generalMacro = "B_mas_cars_Hilux_RKTS";
		scope = 2;
		crew = "B_G_Soldier_M_F";
		typicalCargo[] = {"B_G_Soldier_F"};
		model = "\mas_cars\hilux\hilux_RKTS";
		picture = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\Offroad_01_armed_CA.paa";
		Icon = "\A3\Soft_F_Gamma\Offroad_01\Data\UI\map_offroad_armed_CA.paa";
		mapSize = 4;
		displayName = "Hilux-GRAD MLRS";
		transportSoldier = 0;
		...
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				...
				gunnerAction = "mas_Hilux_cargo01";
				gunnerInAction = "mas_Hilux_cargo01";
				gunnerOpticsModel = "\mas_cars\UAZ\2Dscope_SPG_4";
				soundServo[] = {"A3\sounds_f\dummysound", "db-40", 1.0, 10};
				stabilizedInAxes = "StabilizedInAxesNone";
